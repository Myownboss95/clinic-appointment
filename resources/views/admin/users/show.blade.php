                               ...
                               <div class="card bg-transparent shadow-none">
                                   <div class="card-body">
                                        <ul class="nav nav-tabs-custom card-header-tabs border-top mt-2" id="pills-tab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link px-3" data-bs-toggle="tab" href="#appointments" role="tab">Appointments</a>
                                            </li>
                                            <li class="nav-item">
   
                                                <a class="nav-link px-3" data-bs-toggle="tab" href="#transactionstab" role="tab">Transactions</a>
 
                                            </li>
                                            <li class="nav-item">
   
                                                <a class="nav-link px-3" data-bs-toggle="tab" href="#updateuser" role="tab">Update User Info</a>
                                                    ...
                                                    <div class="pb-3">
                                                        <div class="text-muted">
                                                            <ul class="list-unstyled mb-0">
                                                                <li class="py-1"><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>Phone Number: {{$user->phone_number}}</li>
                                                    ...
                                                    <div>
                                                        <div>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input class="form-control" name="phone_number" type="tel" value="{{old('phone_number', $user->phone_number)}}" id="example-tel-input">
                                                            </div>
