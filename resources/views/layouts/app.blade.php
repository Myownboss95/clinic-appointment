...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('lineone/app.css') }}" />

    <!-- Javascript Assets -->
    <script src="{{ asset('lineone/app.js') }}" defer></script>
    ...
    {{-- enf of new dashboard styling --}}
</head>

<body class="hold-transition sidebar-mini layout-fixed" x-data class="is-header-blur"
