                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1">
                                            <span class="text-muted mb-3 lh-1 d-block text-truncate">Initiated Transactions</span>
                                            <h4 class="mb-3">
                                                <span class="counter-value" data-target={{ $transactions?->count() }}>0</span>
                                            </h4>
                     ...
                     <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <livewire:user-initiated-transactions-table userId="{{$user->id}}"/>
                                </div>
                                <!-- end card body -->
                            </div>
                            <!-- end card -->
